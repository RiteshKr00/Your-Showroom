...
const steps = [
    {
        id: "1",
        message: "Hey! I am Car bot, how are you feeling today",
        trigger: "expressions",
    },
    {
        id: "expressions",
    ...
    },
    {
        ...
        options: [
            ...
            { value: "BMW M3 Sedan", label: "BMW M3 Sedan", trigger: "selectedService" },
            { value: "Ford Mustang", label: "Ford Mustang", trigger: "selectedService" },
            { value: "Mercedes Benz", label: "Mercedes Benz", trigger: "selectedService" },
            { value: "Rolls Royce Ghost", label: "Rolls Royce Ghost", trigger: "selectedService" },
    ...
    const handleEnd = ({ steps, values }) => {
        switch (values[values.length - 1]) {
            ...
            case "Ford Mustang":
                ...
                break;
            case "Mercedes Benz":
                history.push("/mercedes");
                break;
            case "Rolls Royce Ghost":
                history.push("/rollsRoyce");
                break;
            default:
                break;
        }
        ...
        <div className="chatbot">
            <ThemeProvider theme={theme}>
                <ChatBot
                    ...
                    opened={opened}
                    headerTitle="Car bot"
                    botAvatar="https://image.freepik.com/free-vector/cute-smiling-robot-chat-bot-communication-signs-modern-flat-cartoon-character-illustration-isolated-white-speak-bubble-voice-support-service-communication-chat-bot_92289-518.jpg"
                    avatarStyle={{ borderRadius: "100%" }}
                    floating={true}
                    floatingIcon={
                        <img src="https://image.freepik.com/free-vector/cute-smiling-robot-chat-bot-communication-signs-modern-flat-cartoon-character-illustration-isolated-white-speak-bubble-voice-support-service-communication-chat-bot_92289-518.jpg" style={{ width: "70%" }} alt="chatBot icon" />
                    }
                    floatingStyle={{
